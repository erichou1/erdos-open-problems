...
> - **Still open (honest, verdict INCOMPLETE):** autonomous Aristotle inside *campaigns*; production scholarly/theorem-library retrieval; mid-generation rate-limit detection; DB-backed campaign leases; and a LIVE browser→Lean→`FORMALLY_VERIFIED_CANDIDATE` run.
